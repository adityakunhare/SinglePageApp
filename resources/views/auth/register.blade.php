...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6 ">
        ...
        <h2 class="text-blue-300">Enter your details to register</h2>
        <form method="POST" action="{{ route('register') }}" class="pt-8 ">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="name" type="text"
                        ...
                        name="name" autofocus placeholder="Your name">
            ...
            <div class="relative pt-3">
                <label for="confirm-password"
                    class="uppercase text-blue-500 text-xs font-bold  absolute pl-3 pt-2">Confirm Password</label>
